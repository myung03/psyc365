...
import { Heading, Text, Button, UnorderedList, ListItem, Box, Image, Grid, GridItem, Step, Stepper, StepIndicator, StepStatus, StepIcon, StepNumber, StepSeparator } from '@chakra-ui/react'
    ...
    <Grid
      ...
      >
        <Box>
          ...
          <Text mt={2}>
          Each of the alpha, beta, and gamma synchrony exhibited a higher level of inter-brain synchrony during block 2 compared to block 1; the increase in synchrony from the first to the second block indicates that after an experience with joint coordination task in the first half of the experiment, participant pairs experienced an increase in inter-brain synchrony for the remaining trials. The increase in oscillation synchrony can be attributed to familiarity with the online task, enhanced communication techniques, and improved coordination between participants. 
          </Text>
          <Text mt={2}>
